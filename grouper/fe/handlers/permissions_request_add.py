...
class PermissionsRequestAdd(GrouperHandler):
    @staticmethod
    ...
    def get(self, name=None):
        ...
        print(args_by_perm)
        dropdown_form, text_form = self._get_forms(args_by_perm, None)

        self.render(
            "permission-request-add.html",
    ...
    def post(self, group_id=None, name=None):
        ...
        dropdown_form, text_form = self._get_forms(
